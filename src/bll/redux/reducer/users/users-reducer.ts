...
import {userPageApiType} from "../../../../api/user/usersAPI";
import {userActionType} from "./user-actions/users-actions-type";
...
export const usersReducer = (state: userPageType = inisialState, action: userActionType): userPageType => {
   switch (action.type) {
